...
sudo pacman -S --needed lib32-mesa lib32-libva-mesa-driver xf86-video-amdgpu #lib32-mesa-vdpau
...
sudo pacman -S --needed lib32-vulkan-radeon lib32-vulkan-swrast #amdvlk lib32-amdvlk
